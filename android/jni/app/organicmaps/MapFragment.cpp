...
Java_app_organicmaps_MapFragment_nativeCompassUpdated(JNIEnv * env, jclass clazz, jdouble north, jboolean forceRedraw)
{
...
JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeStorageConnected(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeStorageDisconnected(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeScalePlus(JNIEnv * env, jclass clazz)
{
  g_framework->Scale(::Framework::SCALE_MAG);
}

JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeScaleMinus(JNIEnv * env, jclass clazz)
{
  g_framework->Scale(::Framework::SCALE_MIN);
}

JNIEXPORT jboolean JNICALL
Java_app_organicmaps_MapFragment_nativeShowMapForUrl(JNIEnv * env, jclass clazz, jstring url)
{
  return g_framework->ShowMapForURL(jni::ToNativeString(env, url));
}

JNIEXPORT jboolean JNICALL
Java_app_organicmaps_MapFragment_nativeCreateEngine(JNIEnv * env, jclass clazz,
...
JNIEXPORT jboolean JNICALL
Java_app_organicmaps_MapFragment_nativeIsEngineCreated(JNIEnv * env, jclass clazz)
{
  return g_framework->IsDrapeEngineCreated();
}

JNIEXPORT jboolean JNICALL
Java_app_organicmaps_MapFragment_nativeDestroySurfaceOnDetach(JNIEnv * env, jclass clazz)
{
  return g_framework->DestroySurfaceOnDetach();
}

JNIEXPORT jboolean JNICALL
Java_app_organicmaps_MapFragment_nativeAttachSurface(JNIEnv * env, jclass clazz,
                                                         jobject surface)
{
...
JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeDetachSurface(JNIEnv * env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativePauseSurfaceRendering(JNIEnv *, jclass)
{
  g_framework->PauseSurfaceRendering();
}

JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeResumeSurfaceRendering(JNIEnv *, jclass)
{
  g_framework->ResumeSurfaceRendering();
}

JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeSurfaceChanged(JNIEnv * env, jclass, jobject surface,
                                                          jint w, jint h)
{
...
JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeOnTouch(JNIEnv * env, jclass clazz, jint action,
...
JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeSetupWidget(
...
JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeSetupMyPosition(JNIEnv * env, jclass clazz, int offsetY)
{
  g_framework->UpdateMyPositionRoutingOffset(offsetY);
}

JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeApplyWidgets(JNIEnv * env, jclass clazz)
{
  g_framework->ApplyWidgets();
}

JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeCleanWidgets(JNIEnv * env, jclass clazz)
{
  g_framework->CleanWidgets();
}

JNIEXPORT void JNICALL
Java_app_organicmaps_MapFragment_nativeSetRenderingInitializationFinishedListener(
